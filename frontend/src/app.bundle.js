...
const opportunities = [
  ...
  },
  {
    ...
    match: 91,
    summary: "学校综合物业与秩序维护一体化采购，服务范围清晰，预算位于偏好区间内，适合快速组织应标。",
    reasons: ["学校业态匹配", "预算在偏好区间", "招标文件已获取"],
    nextAction: "核对人员证书与近三年学校服务案例",
    favorite: false,
    watching: false
  },
  {
    id: "cq-park-006",
    title: "重庆悦来智慧园区物业与设施运维服务项目",
    type: "实时招标",
    stage: "资格预审",
    city: "重庆",
    industry: "工业园区",
    budget: "830 万元/年",
    buyer: "重庆悦来投资集团有限公司",
    deadline: "2026-07-18 16:30",
    match: 86,
    summary: "园区物业与设施运维打包采购，关注工程维修、能耗巡检和应急响应能力，可作为高预算拓展项目。",
    reasons: ["预算规模高", "设施运维能力匹配", "本地资源可承接"],
    nextAction: "评估工程班组配置与夜间值守成本",
    favorite: false,
    watching: false
  },
  {
    id: "cq-university-007",
    ...
    deadline: "预计 2026-10",
    match: 95,
    summary: "虎溪校区现有物业合同预计未来六个月内到期，服务体量较大，适合提前梳理高校后勤资源并建立校方沟通路径。",
    reasons: ["高校/大学", "未来6个月到期", "提前建联"],
    nextAction: "提前整理高校物业同类业绩，制定后勤处拜访与续约情报跟踪计划",
    favorite: false,
    watching: false
  },
  {
    id: "cq-university-008",
    ...
    deadline: "预计 2026-11",
    match: 92,
    summary: "北碚校区后勤物业合同预计进入续约窗口，服务范围覆盖楼宇、环境、会务与应急保障，可提前评估潜在换手机会。",
    reasons: ["高校/大学", "偏好金额", "未挂网"],
    nextAction: "监控校方采购计划和合同到期节点，准备提前建联材料",
    favorite: false,
    watching: false
  },
  {
    id: "cq-university-009",
    ...
    deadline: "预计 2026-12",
    match: 89,
    summary: "大学城校区物业服务存在未来到期信号，预算处于偏好区间，适合作为高校未挂网商机持续盯防。",
    reasons: ["高校/大学", "学校物业", "到期预测"],
    nextAction: "持续监测采购意向公告，并补齐学校物业项目评价材料",
    favorite: false,
    watching: false
  },
  {
    id: "cq-school-010",
    title: "重庆工商大学南岸校区物业综合服务项目",
    type: "实时招标",
    stage: "报名中",
    city: "重庆",
    industry: "学校",
    ...
    match: 86,
    summary: "高校教学楼、办公楼及公共区域综合物业服务，已发布招标公告，适合纳入重庆高校物业项目池。",
    reasons: ["高校/大学", "已挂网", "100-1000万"],
    nextAction: "核对项目经理与关键岗位人员配置",
    favorite: false,
    watching: false
  },
  {
    id: "cq-school-011",
    title: "重庆理工大学花溪校区物业管理服务项目",
    type: "实时招标",
    stage: "报名中",
    city: "重庆",
    industry: "学校",
    ...
    match: 88,
    summary: "高校教学楼、实验楼、宿舍及公共区域综合物业服务已挂网，预算处于偏好金额区间。",
    reasons: ["高校/大学", "已挂网", "100-1000万"],
    nextAction: "核对高校项目经理履历和近三年校园物业业绩",
    favorite: false,
    watching: false
  },
  {
    id: "cq-school-012",
    title: "重庆邮电大学南山校区物业综合服务项目",
    type: "实时招标",
    stage: "报名中",
    city: "重庆",
    industry: "学校",
    budget: "810 万元/年",
    buyer: "重庆邮电大学",
    deadline: "2026-08-02 17:30",
    match: 87,
    summary: "南山校区物业综合服务项目已发布招标公告，重点覆盖教学楼宇、公共空间和秩序维护。",
    reasons: ["高校/大学", "已挂网", "服务半径匹配"],
    nextAction: "拆解评分办法，确认人员证书与服务方案响应项",
    favorite: false,
    watching: false
  },
  {
    id: "cq-school-013",
    title: "重庆第二师范学院学府大道校区物业服务项目",
    type: "实时招标",
    stage: "报名中",
    city: "重庆",
    industry: "学校",
    budget: "590 万元/年",
    buyer: "重庆第二师范学院",
    deadline: "2026-08-05 16:30",
    match: 85,
    summary: "学校物业服务招标已挂网，服务内容以环境保洁、楼宇巡检、绿化养护和秩序维护为主。",
    reasons: ["学校物业", "已挂网", "预算匹配"],
    nextAction: "整理学校物业案例和响应报价测算",
    favorite: false,
    watching: false
  }
];
...
const knowledgeCategories = [
  { key: "certificates", name: "资证库", description: "沉淀企业资质、荣誉证书、人员证照与有效期信息。", sort_order: 10 },
  { key: "bids", name: "标书库", description: "归档历史投标文件、响应模板、评分办法与常用章节。", sort_order: 20 },
  { key: "gallery", name: "企业图库", description: "管理企业形象、项目现场、服务团队与案例图片素材。", sort_order: 30 },
  { key: "entities", name: "投标主体库", description: "维护投标主体、联合体、分支机构与授权关系资料。", sort_order: 40 },
  { key: "costs", name: "测算成本库", description: "沉淀人工、物料、管理费、税费和区域成本参数。", sort_order: 50 },
  { key: "custom", name: "自定义知识库", description: "创建新的知识库入口，设置名称与备注解释。", sort_order: 60 }
];
...
const knowledgeDocuments = [
  {
    ...
    type: "标书资料",
    tags: ["学校", "评分办法", "模板"],
    summary: "用于快速识别技术分、商务分和价格分要求，辅助生成投标响应清单。",
    source_filename: "学校物业服务评分办法模板.docx",
    stored_path: null,
    file_size: 0,
    status: "ready",
    created_at: "2026-06-24T09:00:00+08:00",
    updated_at: "2026-06-24T09:00:00+08:00",
    download_url: null
  },
  {
    id: "doc-2",
    ...
    type: "数据表",
    tags: ["重庆", "学校", "历史中标"],
    summary: "沉淀区域内学校物业项目的中标单位、金额区间和合同周期。",
    source_filename: "重庆教育系统历史中标记录.xlsx",
    stored_path: null,
    file_size: 0,
    status: "ready",
  ...
  {
    id: "doc-3",
    category_key: "gallery",
    title: "医院后勤院感服务方案素材",
    type: "案例库",
    tags: ["医院", "后勤", "院感"],
    summary: "整理医院保洁、消杀、运送等场景图文素材，便于标书复用。",
    source_filename: "医院后勤院感服务方案素材.pdf",
    stored_path: null,
    file_size: 0,
    status: "ready",
    created_at: "2026-06-20T14:30:00+08:00",
    updated_at: "2026-06-20T14:30:00+08:00",
    download_url: null
  }
];

const libraryItems = knowledgeDocuments.map((item) => ({
  id: item.id,
  name: item.title,
  type: item.type,
...
const conversations = [
  ...
  },
  {
    ...
    skill: "人脉图谱",
    time: "6月26日",
    prompt: "我有重庆教育系统资源，如何接洽到重庆医科大学绿化项目"
  }
];
...
async function getKnowledgeDocuments(filters = {}) {
...
async function uploadKnowledgeDocument(formData) {
...
async function updateOpportunityState(id, patch) {
